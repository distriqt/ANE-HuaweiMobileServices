...
package
{
	import com.distriqt.test.hmscoreinstaller.Main;
	...
	/**	
	 * Sample application for using the HMSCoreInstaller Native Extension
	 */
	public class TestHMSCoreInstaller extends Sprite
	{
		////////////////////////////////////////////////////////
		//	CONSTANTS
		//
		 ...
		 *  Constructor
		 */
		public function TestHMSCoreInstaller()
		{
			super();
			if(this.stage)
			{
